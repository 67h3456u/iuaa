...
if (typeof GemiusHitcolConnector == "undefined") {
	GemiusHitcolConnector = function(is_gde) {
		...
		if (this.use_globals) {
			...
			this.hc = (typeof gemius_hitcollector === 'string')?gemius_hitcollector:(typeof pp_gemius_hitcollector === 'string')?pp_gemius_hitcollector:'kpmediagaua.hit.gemius.pl';
			...
			this.hc = 'kpmediagaua.hit.gemius.pl';
			this.dnt = 0;
			this.use_cmp = 0;
